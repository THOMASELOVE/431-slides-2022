...
# This is where we'll start for Class 06.

## What have I changed? {.smaller}

Since Tuesday, I changed the following things in the slides prior to this one...

- Changed `dm431.csv` file (and posted it on our [431-data page](https://github.com/THOMASELOVE/431-data)) to have 16 rather than 17 variables.

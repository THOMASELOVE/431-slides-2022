...
- [Assignments](https://thomaselove.github.io/431-2022/assignments.html): Labs, Minute Papers, Quizzes and Projects

## Getting Started (from main web site) {.smaller}
...
2.  Skim through the [Course Syllabus](https://thomaselove.github.io/431-syllabus-2022/).
3.  Obtain a copy of David Spiegelhalter's *The Art of Statistics: How to Learn from Data*, originally published in 2020 and available at all major book retailers for around \$20.
4.  Complete the [Welcome to 431 survey](https://bit.ly/431-2022-welcome-survey). Thanks to those of you who've already done this.
5.  Get started [installing the software](https://thomaselove.github.io/431-2022/software.html) you'll need for the course.
6.  Sign up for the (free) [Campuswire discussion forum](https://thomaselove.github.io/431-2022/campuswire.html) for this class.
...
200 countries over 200 years using 120,000 numbers, in about 4 minutes. View at <http://bit.ly/431-rosling>
...
## Getting Started (again) {.scrollable}

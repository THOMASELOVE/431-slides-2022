...
format:
  revealjs: 
    ...
    footer: "431 Class 06 | 2022-09-15 | https://thomaselove.github.io/431-2022/"
---

## Our Agenda

These slides will be used in Class 05 **and** Class 06. We'll start this time wherever we left off last time.
...
- This sample includes 431 female adults living with diabetes in Cuyahoga County who are within a certain age range, and who have complete data on all 17 variables included in the tibble.
...
- Again, these are 431 female adults living with diabetes in Cuyahoga County within a certain age range, with complete data on the 17 variables in this codebook.
...
dm431 |> group_by(insurance) |>
  summarize(n = n(), mean = round_half_up(mean(age),2), 
